---
title: "What Happens on Citizenship Test Day: A Complete Walkthrough"
slug: citizenship-test-day-walkthrough
excerpt: "A step-by-step guide to your naturalization interview, from arriving at the USCIS office to receiving your decision."
seo_title: "Citizenship Test Day Guide | What to Expect"
seo_description: "Learn exactly what happens during your citizenship interview. A complete walkthrough from arrival to decision, with tips for a successful experience."
status: published
...
- A valid government-issued photo ID (passport or state ID)
- Any documents requested in your appointment letter

**If applicable:**
- Passport and travel records (if you traveled during your residency period)
- Tax returns for the past 5 years (or 3 years if married to a U.S. citizen)
- Court documents (if you've had any legal issues)
- Evidence of Selective Service registration (for men 18-25)
- Marriage certificate and spouse's documents (if applicable)

**Helpful to have:**
- A copy of your completed N-400 application
- Your A-number written down separately
- A folder or envelope to keep documents organized

### Getting There

Plan to arrive 15-30 minutes early. Consider:
- Traffic and parking availability
- Time to pass through security screening
- Walking distance from parking to the building
...
- Weapons of any kind
- Food and drinks (some offices prohibit them)
- Large bags or luggage
- Electronic devices may need to be turned off

### Check-In Process

After security, proceed to the check-in desk or window. You'll:
- Present your appointment notice
- Show your Green Card and photo ID
- Receive instructions on where to wait
...
The officer will first confirm your identity by:
- Examining your Green Card and photo ID
- Asking you to confirm your name, date of birth, and A-number
- Potentially taking your photo or fingerprints
...
**Important tips:**
- Answer truthfully and consistently with your application
- If something has changed since you filed, inform the officer
...
- You answer verbally (no writing)
- The officer marks each answer as correct or incorrect
- Once you get 6 correct, the test ends
- If you get 4 wrong, you'll continue until you pass or fail
...
**What to expect:**
- A sentence on a card or screen
- You read it out loud
- You have up to three attempts to read correctly
- Focus on understanding and pronunciation
...
**What to expect:**
- A simple sentence related to civics
- You write it down as dictated
- You have up to three attempts
- Spelling and punctuation don't need to be perfect, but should be understandable
